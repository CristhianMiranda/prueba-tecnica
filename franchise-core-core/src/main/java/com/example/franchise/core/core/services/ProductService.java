...
public class ProductService {
    ...
    public ProductRecord create(String name, int stock, Long branchId)  {
        ...
        entity.setName(name);
        entity.setStock_quantity(stock);
        entity.setBranch(branchRepository.findById(branchId).get());
        return repository.save(entity);
    }

    @Transactional(rollbackOn = ApiException.class)
    public ProductRecord updateName(Long id, String requestName)  {
    ...
    @Transactional(rollbackOn = ApiException.class)
    public ProductRecord updateStock(Long id, int requestStock)  {
        log.info("ProductService::updateName --id:[{}], --requestStock:[{}]",id,requestStock);
        ProductRecord entity = getById(id);
        entity.setStock_quantity(requestStock);
        return repository.save(entity);
    }
