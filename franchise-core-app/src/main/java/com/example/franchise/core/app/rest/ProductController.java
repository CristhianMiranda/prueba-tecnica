...
public class ProductController {
    ...
    public ProductRecord create(@RequestParam String name, @RequestParam int stock, @RequestParam Long branchId) {
    ...
    @PutMapping(NAME)
    @ResponseStatus(HttpStatus.OK)
    public ProductRecord updateName(@RequestParam Long id, @RequestParam String requestName) {
    ...
    @PutMapping(STOCK)
    @ResponseStatus(HttpStatus.OK)
    public ProductRecord updateStock(@RequestParam Long id, @RequestParam int requestStock) {
